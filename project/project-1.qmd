...
-   Week 1 of project (week of May 13th): Choose a dataset and write up your proposal in `proposal.qmd`.

-   Week 2 of project (week of May 20): Provide peer review to two other teams in the form of issues in their GitHub repos, address the issues left on your team's project repo by closing them with explicit commits. Feel free to get started on your presentation as well.

-   Week 3 of project (week of May 27): Review feedback from me on your proposal and close any remaining issues. Work on your presentation in `presentation.qmd` and write-up in `index.qmd`.

-   Weeks 4-5 of project (weeks of June 3, 10): Work on project
...
**The reviewer / reviewee assignments are as TBD**:
