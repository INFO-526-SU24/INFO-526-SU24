...
#| echo: false
#| message: false
ret_rate <- read_csv(here::here("slides/09", "data", "RetentionRateoverTime.csv")) |> 
  janitor::clean_names()
...
simdata1 <- read_csv(here::here("slides/09", "data", "simdata1.csv")) |>
...
salesStates <- read_csv(here::here("slides/09", "data", "salesStates.csv"))
...
salesStates <- read_csv(here::here("slides/09", "data", "wageDistribution.csv")) |>
  janitor::clean_names() |>
...
Look into the source code at [https://github.com/INFO-526-S24/INFO526-S24/slides/](https://github.com/INFO-526-SU24/INFO-526-SU24/tree/main/slides).
