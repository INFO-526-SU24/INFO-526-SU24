...
ak <- st_read(here::here("slides/16", "data/ak/states.shp"), quiet = TRUE, stringsAsFactors = FALSE)
...
freedom <- read_csv(here::here("slides/16", "data/freedom-2022.csv"), na = c("", "-")) |>
  drop_na()
```
...
us_state_vaccinations <- read_csv(here::here("slides/16", "data/us_state_vaccinations.csv"))
...
election_2020 <- read_csv(here::here("slides/16", "data/us-election-2020.csv"))
```
