...
BA_degrees <- read_csv(here::here("slides/17", "data/BA_degrees.csv"))
```
...
-   [`knitr::kable()`](https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html): "Cheapest" pretty tables in R Markdown
...
-   [gtsummary](https://www.danieldsjoberg.com/gtsummary/): For summarizing statistical output with **gt**
...
-   2022 Posit table contest: [Winners of the 2022 Table Contest](https://posit.co/blog/winners-of-the-2022-table-contest/)
    ...
    -   2024 Table Contest ended in May: <https://posit.co/blog/announcing-the-2024-table-contest/>
