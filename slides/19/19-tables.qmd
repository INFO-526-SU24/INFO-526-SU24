...
-   RQ 5 Due Wed, April 10th
-   Laura Dozal (TA) will be Lecturing April 10th on Network Visualizations
-   Final Project Proposals will be graded by Wed, April 10th
...
BA_degrees <- read_csv(here::here("slides/19", "data/BA_degrees.csv"))
```
