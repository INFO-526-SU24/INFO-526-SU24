...
-   HW: HW 6 is optional, you'll need to explicitly indicate if you're opting out (only if you have done HWs 1-5)

-   Project: Presentations Mon, May 06, 10:30am - 12:30pm (all team members must be there!)
...
freedom <- read_csv(here::here("slides/21", "data/freedom.csv"), na = "-")
